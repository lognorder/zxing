...
-(void) initialScanLineAnimation{
    ...
    //    shapeLayer.position = CGPointMake(self.bounds.size.width/2,10);
    //    shapeLayer.bounds = CGRectMake(0, 0, self.layer.bounds.size.width,2);
    ...
    //    scanAnimation.duration = 10;
    ////    scanAnimation.fromValue = [NSNumber numberWithFloat:0];
    ////    scanAnimation.toValue = [NSNumber numberWithFloat:self.bounds.size.height];
    //    scanAnimation.fromValue = [NSValue valueWithCGPoint:shapeLayer.position];
    //    scanAnimation.toValue = [NSValue valueWithCGPoint:CGPointMake(shapeLayer.position.x, 90)];
    ////    scanAnimation.repeatCount = HUGE_VALF;
    //    [shapeLayer addAnimation:scanAnimation forKey:nil];
    UIView *animationView = [[UIView alloc] initWithFrame:CGRectZero];
    animationView.center = CGPointMake(self.bounds.size.width/2, 10);
    animationView.bounds = CGRectMake(0, 0, self.bounds.size.width, 5);
    ...
    //view to animate
    animationView.center = CGPointMake(self.bounds.size.width/2, 90);
